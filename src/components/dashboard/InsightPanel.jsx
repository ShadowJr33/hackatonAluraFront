...
export default function InsightPanel({ customer, onClose }) {
    ...
    const isHighRisk = customer.churnProb > 0.75;
    ...
    return (
        ...
        >
            ...
            <div className="mt-8 flex flex-col items-center text-center">
                ...
                <p className="font-mono text-neon-cyan">{customer.id}</p>
            </div>
            ...
            <div className="mt-8 space-y-6">
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li className="p-3 rounded bg-white/5 text-sm flex gap-3 text-gray-300">
                            <TrendingDown className="text-alert-red shrink-0" size={18} />
                            <span>
                                <strong className="text-white">Baja Actividad Reciente:</strong> El usuario no ha realizado transacciones en los últimos 45 días.
                            </span>
                        </li>
                        <li className="p-3 rounded bg-white/5 text-sm flex gap-3 text-gray-300">
                            <Zap className="text-yellow-400 shrink-0" size={18} />
                            <span>
                                <strong className="text-white">Edad vs Producto:</strong> El perfil (Edad: {customer.age}) muestra baja afinidad histórica con el plan actual.
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="p-4 rounded-xl bg-gradient-to-br from-neon-cyan/10 to-transparent border border-neon-cyan/20">
                    ...
                    <p className="text-sm text-gray-300 leading-relaxed">
                        Se sugiere ofrecer un descuento del 15% en la renovación anual o contactar proactivamente para asistencia técnica. Este patrón tiene un 60% de éxito de recuperación.
                    </p>
                </div>
            </div>
        </motion.div>
