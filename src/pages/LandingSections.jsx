...
export function TeamSection() {
    const team = [
        { name: "Gabriel Franco", role: "Project Leader & Data Strategy", image: null },
        { name: "Herbert", role: "Data Science Architecture", image: null },
        { name: "Maeztre", role: "Data Science Architecture", image: null },
        { name: "Roxana (Mirai)", role: "Backend & UX Integration", image: null },
    ];
        ...
        <section className="py-24 px-6 border-t border-white/5 bg-navy-deep">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400">Los arquitectos detrás de la predicción.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {team.map((member, idx) => (
                        <Card key={idx} className="group p-6 text-center border-white/5 hover:border-neon-cyan/50 transition-colors">
                            <div className="w-24 h-24 mx-auto rounded-full bg-white/5 mb-6 flex items-center justify-center overflow-hidden border border-white/10 group-hover:border-neon-cyan transition-colors">
                                <Users className="text-gray-500 group-hover:text-neon-cyan" size={32} />
                            </div>
                            <h3 className="text-lg font-bold text-white">{member.name}</h3>
                            <p className="text-sm text-neon-cyan mt-1 mb-4">{member.role}</p>
